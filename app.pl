...
sub machine::domain::ip {
     ...
     while (my $row = <$file>) {
        ...
        print("${me}> \033[0;1;46mADDR IP\033[0;1;30m  \t$res");
        say("\n");
...
sub banner {
    ...
    say("${m}-----------------------------------------------------------------------");
    say("${me}1${pu}.${hi} generator ip ${ku}(${me}fast${ku})");
    say("${me}2${pu}.${hi} domain to ip ${ku}(${me}fast${ku})");
    say("${m}-----------------------------------------------------------------------");
    print("${me}Chosse${pu}> $st");
    my $app = <>;
    chomp($app);
    ...
    if ($app == 1 or $app == 01) {
        ...
        while (1) {
            ...
            say("${cy}<${pu}output${cy}>  \033[0;1;46mBOT RESULT\033[0;1;47m $hi\t$thr$st\n");
        }
    } elsif ($app == 02 && $app == 2) {
        say "";
